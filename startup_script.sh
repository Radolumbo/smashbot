...
# Libs for python
sudo apt -y install libssl-dev libncurses5-dev libsqlite3-dev libreadline-dev libgdm-dev libdb4o-cil-dev libpcap-dev libffi-dev zlib1g libbz2-dev libpq-dev liblzma-dev
